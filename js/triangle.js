function Triangle(pos, column, row, triW, triH, color, canvas){
  ...
  this.y1 = this.tY1;
  this.y2 = this.tY2;//this.tY1;
  this.y3 = this.tY3;//this.tY1;
...
function TrianglesLife(canvasId){
  var instance = this;
  // console.log(this);
  var interval;
  var isRunning = false;
...
// var tl1 = new TrianglesLife('myCanvas1')
// tl1.start();
// var tl2 = new TrianglesLife('myCanvas2')
//tl2.start();
